...
import '../../../../ui/modules/auth/account_not_confirmed_page.dart';
...
Widget makeAccountNotConfirmedPage() => AccountNotConfirmedPage(
      presenter: makeAccountNotConfirmedPresenter(),
    );
