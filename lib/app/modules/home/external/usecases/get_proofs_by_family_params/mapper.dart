  ...
  Entity fromListToEntity(dynamic results) {
    ...
    for (final result in results) {
      if (!result.keys.contains('entityProofConfigId')) {
        throw const MapperException(message: 'Nenhum comprovante encontrado');
      }
      ...
      final proofItemsConfigsObject = <ProofItemConfigs>[];
      ...
      for (final proofItemConfigsResult in proofItemConfigs) {
        ...
        final proofDocumentsConfigsObject = <ProofDocumentConfigs>[];
        ...
        for (final proofDocumentConfigsResult in proofDocumentConfigs) {
          ...
          final proofDocumentConfigsObject = ProofDocumentConfigs(
        ...
        final proofItemConfigsObject = ProofItemConfigs(
      ...
      final scholarshipProofDocumentsObject = <ScholarshipProofDocument>[];
      ...
      for (final scholarshipProofDocumentsResult in scholarshipProofDocuments) {
        ...
        if (proofItemConfig is! Map) {
          throw MapperException(
              message:
                  'Não foi possível recuperar os comprovantes: Campo scholarshipProofDocumentsResult.proofItemConfigé inesperado (${proofItemConfig.runtimeType})');
        }
        if (proofItemConfig.isEmpty) {
          throw const MapperException(
              message:
                  'Não foi possível recuperar os comprovantes: Campo scholarshipProofDocumentsResult.proofItemConfig é vazio');
        }
        ...
        final scholarshipProofDocumentObject = ScholarshipProofDocument(
