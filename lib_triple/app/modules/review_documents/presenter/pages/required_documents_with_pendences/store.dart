...
class Store extends triple.StreamStore<String, StoreState> {
  final get_proofs_with_pendences_by_family_member.Store getProofsStore;
  final send_proof_document_with_pendences.Store sendProofDocumentStore;
  ...
  Store(this.getProofsStore, this.sendProofDocumentStore,
      ...
      if (newList.isEmpty) {
        update(
          EditingSet(
            ...
            scholarshipProofDocumentId: addingState.scholarshipProofDocumentId,
  ...
  Future<void> _sendPhotosAsPdf(
    ...
    await sendProofDocumentStore(send_proof_document_with_pendences.Params(
      acceptTerm: true,
      documentId: documentId,
      file: pdfFile,
      scholarshipProofDocumentId: scholarshipProofDocumentId,
  ...
  Future<void> sendPdf(
      ...
      required bool documentHasDeclarationToShow}) async {
    setLoading(true, force: true);
    await sendProofDocumentStore(
      ...
      update(
        EditingSet(
          ...
          originalAcceptedDocumentId:
              (state as Editing).originalAcceptedDocumentId,
          scholarshipReviewId: state.scholarshipReviewId,
        ),
        force: true,
      );
