@Deprecated('Utiliza-se a entidade global LoggedUser. Ela representa o usuário logado.')
class LoginWithIdEntity {
  String? accessToken;
  String? email;
  bool? emailConfirmed;
  String? id;
  ...
  LoginWithIdEntity({this.accessToken, this.email, this.emailConfirmed, this.id, this.person, this.personId, this.refreshToken, this.refreshTokens, this.roles, this.userEntity, this.userName, this.userRoles});

  LoginWithIdEntity.fromJson(Map<String, dynamic> json) {
