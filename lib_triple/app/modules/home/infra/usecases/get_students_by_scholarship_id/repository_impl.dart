...
import '../../../domain/usecases/get_students_by_scholarship_id/repository.dart';
import '../../../domain/usecases/get_students_by_scholarship_id/result_typedef.dart';
...
class RepositoryImpl implements Repository {
  ...
  Result call(Params params) async {
    try {
      ...
      return const Left(UnknownUsecaseException(message: 'Não foi possível receber o resultado'));
    }
  }
}
