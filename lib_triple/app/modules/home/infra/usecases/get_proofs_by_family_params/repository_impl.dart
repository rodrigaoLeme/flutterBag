...
import '../../../domain/usecases/get_proofs_by_family_params/repository.dart';
import '../../../domain/usecases/get_proofs_by_family_params/result_typedef.dart';
  ...
  Result call(Params params) async {
    try {
      ...
      return const Left(UnknownUsecaseException(
          message: 'Não foi possível receber os comprovantes'));
    }
  }
}
